...
func New(
	...
	*/
	...
	app.VotesystemKeeper = *votesystemmodulekeeper.NewKeeper(
		appCodec,
		keys[votesystemmoduletypes.StoreKey],
		keys[votesystemmoduletypes.MemStoreKey],
		app.GetSubspace(votesystemmoduletypes.ModuleName),
	)
